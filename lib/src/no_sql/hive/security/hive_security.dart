...
class HiveSecurity {
  ...
  ///
  /// Throws a [DatabaseBrokerException] if an error occurs while reading or
  ...
  /// If an error occurs during the write operation, a [DatabaseBrokerException] is
  ...
  /// the encryption key.
  ///
  /// If the secure key is null, a [DatabaseBrokerException] is thrown set
  /// to 'Secure key is null'.
  ///
  /// If an error occurs while reading the secure key a [DatabaseBrokerException] is thrown.
  Future<HiveCipher> readEncryptionCipher() async {
    try {
      ...
      if (secureStorageKey != null) {
        ...
        throw const DatabaseBrokerException(error: 'Secure key is null');
      }
    } catch (e) {
      throw DatabaseBrokerException(error: e.toString());
    }
  }
}
